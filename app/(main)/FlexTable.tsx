          ...
          {list.map((transaction, index) => {
            ...
            return (
              <tr key={`exch-${index}`} className="hover:bg-gray-50 ">
                <td className={`${className} min-w-fit pl-4`}>{excluded.id}</td>
                  ...
                  {!!Object.keys(excluded)?.length && (
                    <div className="flex items-center">
                      <div className="flex flex-col justify-end items-end">
                        ...
                        <span className="text-xs text-gray-500">{`${excluded?.token1} (${excluded.token1_network})`}</span>
                      </div>
                    </div>
                  )}
                </td>
                  ...
                  {!!Object.keys(excluded)?.length && (
                    <div className="flex items-center">
                      <div className="flex flex-col">
                        ...
                        <span className="text-xs text-gray-500">{`${excluded.token2} (${excluded.token2_network})`}</span>
                      </div>
                    </div>
                  )}
                </td>
